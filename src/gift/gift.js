...
function sendGiftToken(_a) {
    return __awaiter(this, arguments, void 0, function* ({ connection, walletPublicKey, signTransaction, recipient, amount, tokenMint = "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", // USDC
     }) {
